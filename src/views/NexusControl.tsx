								...
								<div className="flex items-center gap-4">
									<div className="relative w-full md:w-80">
										...
										<input
											...
											className="w-full pl-10 pr-10 py-2.5 bg-slate-950 border border-slate-800 rounded-2xl text-xs text-white placeholder-slate-500 outline-none focus:border-indigo-500 transition-all font-medium"
										/>
										{searchQuery && (
											<button
