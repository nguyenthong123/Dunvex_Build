...
- KHI LÊN ĐƠN HÀNG (CREATE_ORDER): 
  ...
  + ĐẶC BIỆT LƯU Ý: Nếu khách hàng CỐ TÌNH CHỈ ĐỊNH danh mục/laoị giá (VD: "với đơn hàng này giá tại kho", "lấy giá thi công"), bạn PHẢI áp dụng danh mục đó (VD: "giá tại kho") cho 'category' của TẤT CẢ các sản phẩm trong đơn, thay vì lấy danh mục gốc trong từ điển.
