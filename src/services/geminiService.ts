...
const botResponseSchema: Schema = {
    ...
    properties: {
        intent: {
            ...
            description: "Mục đích của câu lệnh: CREATE_ORDER, UPDATE_ORDER, CREATE_CUSTOMER, CREATE_PRODUCT, SEARCH_CUSTOMER, UPDATE_CUSTOMER, CREATE_PAYMENT, INVENTORY_ACTION, UNKNOWN",
        },
        order_id: {
            type: SchemaType.STRING,
