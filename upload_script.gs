...
function handleLoanReminder(data) {
  ...
  var subject = "🔔 [NHẮC TẤT TOÁN] Khoản vay " + bankName + " sắp đến hạn";
  ...
  var body = 
    ...
    "<h2 style='margin: 0; text-transform: uppercase; letter-spacing: 1px;'>Nhắc Hẹn Tất Toán</h2>" +
    "<p style='margin: 5px 0 0; font-size: 13px; opacity: 0.8;'>Hệ thống quản trị tài chính Dunvex</p>" +
    "</div>" +
    ...
    "<p style='margin: 5px 0;'><strong>Lãi suất:</strong> " + interestRate + "%/năm</p>" +
    "<p style='margin: 5px 0;'><strong>Kỳ hạn:</strong> " + loanTerm + "</p>" +
    "</div>" +
    
    "<p style='font-weight: bold; color: #15803d;'>Hành động đề xuất:</p>" +
    "<ul>" +
    "<li>Kiểm tra số dư tài khoản ngân hàng.</li>" +
    "<li>Chuẩn bị nguồn tiền để tất toán đúng hạn (Ngày 25).</li>" +
    "<li>Đảm bảo điểm tín dụng doanh nghiệp luôn ở mức tốt nhất.</li>" +
    "</ul>" +
    
    "<p style='margin-top: 30px; font-size: 11px; color: #999; text-align: center; border-top: 1px solid #eee; padding-top: 20px;'>Hệ thống gửi nhắc nhở tự động 5 ngày trước hạn tất toán. Vui lòng không trả lời email này.</p>" +
    "</div>" +
    "</div>";
